...
# Assumptions used
# i) b = 0
# ii) Cobb-Douglas aggregator for intermediates.
# iii) lower bound on the z draw is 1.
# iv) tau > 1 / 2 so that the "amount" of entrepreneurs grows with the productivity level.
